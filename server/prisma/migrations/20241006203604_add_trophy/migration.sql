...
INSERT INTO "new_Season" ("createdAt", "endDate", "id", "isCurrent", "leagueId", "name", "startDate", "updatedAt") SELECT "createdAt", "endDate", "id", "isCurrent", "leagueId", "name", "startDate", "updatedAt" FROM "Season";
DROP TABLE "Season";
