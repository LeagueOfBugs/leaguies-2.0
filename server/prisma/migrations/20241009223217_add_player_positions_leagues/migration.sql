...
INSERT INTO "new_Season" ("active", "createdAt", "endDate", "id", "isCurrent", "leagueId", "name", "startDate", "trophyId", "updatedAt") SELECT "active", "createdAt", "endDate", "id", "isCurrent", "leagueId", "name", "startDate", "trophyId", "updatedAt" FROM "Season";
DROP TABLE "Season";
